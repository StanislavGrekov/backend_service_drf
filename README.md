...
4.Попробовал сделать регистрацию через социальную сеть VK, получилось, user залетает в БД. Но я так и не разобрался как вытащить пользователя из сессии при регистрации.
